...
let PlanToGoalGoal = require('./PlanToGoalGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class PlanToGoalActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = PlanToGoalGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PlanToGoalActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = PlanToGoalGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new PlanToGoalGoal()
    }
...
module.exports = PlanToGoalActionGoal;
