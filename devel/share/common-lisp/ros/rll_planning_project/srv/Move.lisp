...
(cl:defmethod cl:initialize-instance :after ((m <Move-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Move-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rll_planning_project-srv:<Move-request> is deprecated: use rll_planning_project-srv:Move-request instead.")))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <Move-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rll_planning_project-srv:pose-val is deprecated.  Use rll_planning_project-srv:pose instead.")
  (pose m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Move-request>)))
  ...
  "rll_planning_project/MoveRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Move-request)))
  "Returns string type for a service object of type 'Move-request"
  "rll_planning_project/MoveRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <Move-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Move-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rll_planning_project-srv:<Move-response> is deprecated: use rll_planning_project-srv:Move-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Move-response>)))
  ...
  "rll_planning_project/MoveResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Move-response)))
  "Returns string type for a service object of type 'Move-response"
  "rll_planning_project/MoveResponse")
